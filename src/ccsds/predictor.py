...
class SpectralPredictor(nn.Module):
    ...
    def _get_neighborhood_samples(self, image, z, y, x):
        """
    ...
    def _compute_local_differences(self, samples):
        """
    ...
    def _update_weights(self, prediction_error, local_differences, z):
        """
    ...
    def predict_sample(self, image, sample_representatives, z, y, x):
        """
